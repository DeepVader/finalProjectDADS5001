...
from sklearn.model_selection import (
    ...
    GridSearchCV,
    RandomizedSearchCV,
)  # นำเข้า GridSearchCV, RandomizedSearchCV
...
def remove_outliers_grouped(df, target_col="price"):
    ...
    return df.groupby(
        ["neighbourhood", "room_type", "property_grouped", "bedrooms"], group_keys=False
    ).apply(iqr_filter)
...
model_choice = st.selectbox(
    "Select Model:", ["Random Forest", "Linear Regression", "Decision Tree", "XGBoost"]
)
